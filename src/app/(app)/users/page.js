    ...
    <>
      {user?.role == 1 ? (
          ...
          >
            ...
            <div className="mt-6 flex justify-end space-x-3">
              ...
              <button
                onClick={submitUser}
                disabled={loading}
                className={`px-4 py-2 text-sm rounded-md text-white ${loading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
                  }`}
              >
                {loading
                  ? modalType === 'edit'
        ...
        <div className="p-6 text-center text-gray-600">
          <h2>You don’t have permission to manage users.</h2>
        </div>
      )}
    </>
  )
