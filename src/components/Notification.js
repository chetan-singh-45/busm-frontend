...
const Notification = ({ fetchNotifications }) => {
  const { user } = useAuth();
        ...
        >
          <button
            ...
            className={`block w-full px-4 py-2 text-left text-sm hover:bg-gray-100 ${
              selectedCountry === 'all' ? 'font-semibold text-blue-600' : ''
            }`}
          >
            All Countries
          </button>
          {countries.map((country) => (
            <button
              ...
              className={`block w-full px-4 py-2 text-left text-sm hover:bg-gray-100 ${
                selectedCountry.toLowerCase() === country.toLowerCase() ? 'font-semibold text-blue-600' : ''
              }`}
            >
              {country}
            </button>
            ...
            <table className="min-w-full table-auto border-collapse">
              <thead className="bg-gray-100 sticky top-0 z-10">
                <tr>
                  ...
                  <th className="px-4 py-3 text-center">View Chart</th>
                </tr>
              </thead>
              <tbody>
                      ...
                      <tr key={notification.id} className="border-t hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-center">
                          <div className="flex items-center justify-center">
                            <Link href={`/overview/${notification.stock_symbol}`} className="text-blue-600 hover:underline" >
